...
class Inference(object):
    ...
    def generate_question_title(self,
                                raw_input_text,
                                title_maxlen=None):
        """
    ...
    def print_example(self,
        ...
        emb, gen_title = self.generate_question_title(body_text)
        ...
        if min(dist) <= threshold:
            cols = ['question_url', 'question_title', 'body']
    ...
    def demo_model_predictions(self,
        ...
        question_df : pandas DataFrame
            DataFrame that contains two columns: `body` and `question_title`.
        threshold : float
        ...
        title_text = question_df.question_title.tolist()
        url = question_df.question_url.tolist()
    ...
    def prepare_recommender(self, vectorized_array, original_df):
        ...
        original_df : pandas.DataFrame
            ...
            ['question_url', 'question_title', 'body']
